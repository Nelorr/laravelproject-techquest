                    ...
                    @csrf
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="text" name="fname" value="{{ old('fname') }}" class="form-control form-control-user @error('fname') is-invalid @enderror" id="fname" required autocomplete="fname" autofocus
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="lname" value="{{ old('lname') }}" class="form-control form-control-user @error('lname') is-invalid @enderror" id="lname" required autocomplete="lname" autofocus
